...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val foodName = listOf("BreakFast","Green Salad","Rolls","Ice Cream")
        val price = listOf("$5","$7","$8","$9")
        val popularFoodImages= listOf(R.drawable.breakfast,R.drawable.green_salad,R.drawable.rolls,R.drawable.ice_cream)
